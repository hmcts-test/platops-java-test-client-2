...
Library automatically published to [JitPack](https://jitpack.io/#hmcts/platops-java-client-3), build logs and compiled libraries can be found by going to [hmcts/platops-java-client-3](https://jitpack.io/com/github/hmcts/platops-java-client-3). The [Jitpack Build workflow](.github/workflows/jitpack_build.yml) will run when a tag has been created forcing JitPack to build the library so its readily available.
